      ...
      <section className={s.root}>
        <Tabs index={this.state.index} onChange={this.handleTabChange} fixed>
          <Tab label="Faculty">
            ...
            <p>Techniques for optimization of large complex systems have recently been proposed that mimic the manner in which genetic mutations succeed in natural selection, and others mimic the manner in which animal colonies (notably ants and bees) communicate simple individual directives in order to produce a coherent behavior that results in intelligent actions with purpose that goes beyond what each individual can grasp.</p><br />
